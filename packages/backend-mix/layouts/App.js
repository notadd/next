                            ...
                            (wd === 'xs' || wd === 'sm') ?
                                React.createElement("div", { className: "mobile-header" },
                                    React.createElement("div", { className: "top-menu" },
                                        React.createElement(IconButton, { "aria-haspopup": "true", className: this.props.classes.menuBtn, color: "contrast", onClick: this.toggleDrawer }, open ? React.createElement(Close, null) : React.createElement(MenuIcon, null)),
                                        React.createElement(Link, { to: "/home" },
                                            React.createElement("img", { className: this.props.classes.logo, src: require('../assets/images/notadd_logo.png') })),
                                        React.createElement("div", null,
                                            React.createElement(IconButton, { "aria-haspopup": "true", style: { marginLeft: '0' }, className: this.props.classes.menuBtn, onClick: this.handleOpenSearch, color: "contrast" },
                                                React.createElement(Search, null)),
                                            React.createElement(IconButton, { "aria-haspopup": "true", style: { marginLeft: '0' }, className: this.props.classes.menuBtn, color: "contrast" },
                                            ...
                                            React.createElement(Popover, { open: openSearch, anchorPosition: { top: 0, left: 0 }, anchorOrigin: {
                                                ...
                                                }, className: "mobile-search", onClose: this.handleClose },
                                    ...
                                    React.createElement("div", { className: "menus-list" },
                                        React.createElement(BottomNavigation, { value: current, onChange: this.handleChange, showLabels: true, className: this.props.classes.root }, this.state.navs.map((item, index) => {
                                ...
                                React.createElement("div", { className: "header" },
                                    React.createElement("div", { className: this.props.classes.headerLeft },
                                        React.createElement(Link, { to: "/home" },
                                            React.createElement("img", { className: this.props.classes.logo, src: require('../assets/images/notadd_logo.png') })),
                                        React.createElement(IconButton, { "aria-haspopup": "true", className: this.props.classes.menuBtn, color: "contrast", onClick: this.toggleDrawer }, open ? React.createElement(Close, null) : React.createElement(MenuIcon, null)),
                                        React.createElement(IconButton, { "aria-haspopup": "true", style: { marginLeft: '0' }, className: this.props.classes.menuBtn, onClick: this.handleFullScreen, color: "contrast" },
                                    ...
                                    React.createElement("div", { className: this.props.classes.navUser },
                                        ...
                                        React.createElement(IconButton, { "aria-haspopup": "true", className: this.props.classes.iconBtn, style: { marginRight: '10px' }, color: "contrast" },
                                            React.createElement(Setting, null)))),
                            React.createElement("div", { className: classNames('view', condition && 'smallSide-view', wd === 'sm' && 'sm-content') },
                                condition ?
                                    React.createElement(Drawer, { type: "persistent", classes: {
                                            modal: classes.root,
                                            docked: classNames(classes.drawerDocked, (!this.state.open || open && wd === 'sm')
                                                ?
                                        ...
                                        React.createElement(Side, { open: this.state.open, sideNav: this.state.navs[this.state.current].side }))
                                    :
                                        React.createElement(Drawer, { type: "persistent", classes: {
                                                modal: classes.root,
                                                docked: classNames(classes.drawerDocked, !this.state.open && classes.xsDrawerPaperClose),
                                                paper: classes.drawerPaper
                                            }, onClose: this.toggleDrawer, open: this.state.open },
                                            React.createElement(Side, { open: this.state.open, sideNav: this.state.navs[this.state.current].side })),
                                React.createElement("div", { className: classNames('content', this.state.open && wd !== 'sm' && 'move-content') },
                                    React.createElement(Switch, null,
                                        ...
                                        React.createElement(Route, { exact: true, path: "/menu/edit/:id", component: MenuEdit }),
                                        ...
                                        React.createElement(Route, { exact: true, path: "/cms/article/type/edit/:id", component: ArticleTypeEdit }),
                                        React.createElement(Route, { exact: true, path: "/cms/article/type/message/:type", component: ArticleEditMessage }),
                                        ...
                                        React.createElement(Route, { exact: true, path: "/cms/page/type/edit/:id", component: PageTypeEdit }),
