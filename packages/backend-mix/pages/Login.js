...
class Login extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "login" },
            ...
            React.createElement(Snackbar, { open: this.state.open, anchorOrigin: { vertical: 'top', horizontal: 'right' }, onClose: this.handleClose, transition: this.state.transition, SnackbarContentProps: {
