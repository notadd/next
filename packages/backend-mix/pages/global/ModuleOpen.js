...
class ModuleOpen extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("h4", { className: "title" }, "\u5F00\u542F\u6A21\u5757"),
            React.createElement(Paper, { className: "root-paper" },
                ...
                React.createElement("div", { className: "table-pagination" },
                    React.createElement(ReactPaginate, { previousLabel: '<', nextLabel: '>', breakLabel: React.createElement("a", { href: "javascript: void (0);" }, "..."), breakClassName: 'break-me', pageCount: list.length / rowsPerPage, marginPagesDisplayed: 2, pageRangeDisplayed: 2, onPageChange: this.handlePageClick, containerClassName: 'pagination', activeClassName: 'active' }))),
            ...
            React.createElement(Snackbar, { classes: {}, open: this.state.snackOPen, anchorOrigin: { vertical: 'top', horizontal: 'right' }, onClose: this.handleClose, transition: this.state.transition, SnackbarContentProps: {
