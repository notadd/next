...
var withUtils = function withUtils() {
  return function (Component$$1) {
    var WithUtils = function WithUtils(props, context) {
      ...
      return React__default.createElement(Component$$1, _extends({ utils: context.muiPickersDateUtils }, props));
    };
...
exports.TimePicker = index$1;
exports.DateTimePicker = index$2;
exports.MuiPickersUtilsProvider = MuiPickersUtilsProvider;
exports.dateFnsUtils = DateFnsUtils;
